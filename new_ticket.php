		...
		<div class="card-body">
			<form action="" id="manage_ticket">
				<input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">موضوع الخدمة</label>
					...
					<?php endif; ?>
						<div class="form-group">
							<label for="" class="control-label">نوع المشكلة</label>
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					<button class="btn btn-primary mr-2">خفظ</button>
					<button class="btn btn-secondary" type="reset">محو</button>
				</div>
			</form>
		</div>
	</div>
